...
public class MemberCollectSpuController extends BaseController
{
     ...
     * 查询会员收藏的商品列表
     */
//@RequiresPermissions("member:spu:list")
    @GetMapping("/list")
     ...
     * 导出会员收藏的商品列表
     */
    //@RequiresPermissions("member:spu:export")
     ...
     * 获取会员收藏的商品详细信息
     */
    //@RequiresPermissions("member:spu:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增会员收藏的商品
     */
    //@RequiresPermissions("member:spu:add")
     ...
     * 修改会员收藏的商品
     */
    // @RequiresPermissions("member:spu:edit")
     ...
     * 删除会员收藏的商品
     */
    //@RequiresPermissions("member:spu:remove")
