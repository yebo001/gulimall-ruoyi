...
public class SeckillSkuNoticeController extends BaseController
{
     ...
     * 查询秒杀商品通知订阅列表
     */
//@RequiresPermissions("coupon:notice:list")
    @GetMapping("/list")
     ...
     * 导出秒杀商品通知订阅列表
     */
    //@RequiresPermissions("coupon:notice:export")
     ...
     * 获取秒杀商品通知订阅详细信息
     */
    //@RequiresPermissions("coupon:notice:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增秒杀商品通知订阅
     */
    //@RequiresPermissions("coupon:notice:add")
     ...
     * 修改秒杀商品通知订阅
     */
    // @RequiresPermissions("coupon:notice:edit")
     ...
     * 删除秒杀商品通知订阅
     */
    //@RequiresPermissions("coupon:notice:remove")
