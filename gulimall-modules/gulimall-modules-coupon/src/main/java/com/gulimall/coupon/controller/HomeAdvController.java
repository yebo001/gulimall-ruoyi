...
public class HomeAdvController extends BaseController
{
     ...
     * 查询首页轮播广告列表
     */
//@RequiresPermissions("coupon:adv:list")
    @GetMapping("/list")
     ...
     * 导出首页轮播广告列表
     */
    //@RequiresPermissions("coupon:adv:export")
     ...
     * 获取首页轮播广告详细信息
     */
    //@RequiresPermissions("coupon:adv:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增首页轮播广告
     */
    //@RequiresPermissions("coupon:adv:add")
     ...
     * 修改首页轮播广告
     */
    // @RequiresPermissions("coupon:adv:edit")
     ...
     * 删除首页轮播广告
     */
    //@RequiresPermissions("coupon:adv:remove")
