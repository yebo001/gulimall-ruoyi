...
public class SpuBoundsController extends BaseController
{
     ...
     * 查询商品spu积分设置列表
     */
//@RequiresPermissions("coupon:bounds:list")
    @GetMapping("/list")
     ...
     * 导出商品spu积分设置列表
     */
    //@RequiresPermissions("coupon:bounds:export")
     ...
     * 获取商品spu积分设置详细信息
     */
    //@RequiresPermissions("coupon:bounds:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增商品spu积分设置
     */
    //@RequiresPermissions("coupon:bounds:add")
     ...
     * 修改商品spu积分设置
     */
    // @RequiresPermissions("coupon:bounds:edit")
     ...
     * 删除商品spu积分设置
     */
    //@RequiresPermissions("coupon:bounds:remove")
