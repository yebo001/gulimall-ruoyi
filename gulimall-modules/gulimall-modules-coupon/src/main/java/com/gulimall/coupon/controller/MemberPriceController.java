...
public class MemberPriceController extends BaseController
{
     ...
     * 查询商品会员价格列表
     */
//@RequiresPermissions("coupon:price:list")
    @GetMapping("/list")
     ...
     * 导出商品会员价格列表
     */
    //@RequiresPermissions("coupon:price:export")
     ...
     * 获取商品会员价格详细信息
     */
    //@RequiresPermissions("coupon:price:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增商品会员价格
     */
    //@RequiresPermissions("coupon:price:add")
     ...
     * 修改商品会员价格
     */
    // @RequiresPermissions("coupon:price:edit")
     ...
     * 删除商品会员价格
     */
    //@RequiresPermissions("coupon:price:remove")
