...
public class HomeSubjectSpuController extends BaseController
{
     ...
     * 查询专题商品列表
     */
//@RequiresPermissions("coupon:spu:list")
    @GetMapping("/list")
     ...
     * 导出专题商品列表
     */
    //@RequiresPermissions("coupon:spu:export")
     ...
     * 获取专题商品详细信息
     */
    //@RequiresPermissions("coupon:spu:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增专题商品
     */
    //@RequiresPermissions("coupon:spu:add")
     ...
     * 修改专题商品
     */
    // @RequiresPermissions("coupon:spu:edit")
     ...
     * 删除专题商品
     */
    //@RequiresPermissions("coupon:spu:remove")
