...
public class SkuLadderController extends BaseController
{
     ...
     * 查询商品阶梯价格列表
     */
//@RequiresPermissions("coupon:ladder:list")
    @GetMapping("/list")
     ...
     * 导出商品阶梯价格列表
     */
    //@RequiresPermissions("coupon:ladder:export")
     ...
     * 获取商品阶梯价格详细信息
     */
    //@RequiresPermissions("coupon:ladder:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增商品阶梯价格
     */
    //@RequiresPermissions("coupon:ladder:add")
     ...
     * 修改商品阶梯价格
     */
    // @RequiresPermissions("coupon:ladder:edit")
     ...
     * 删除商品阶梯价格
     */
    //@RequiresPermissions("coupon:ladder:remove")
