...
public class WareOrderTaskController extends BaseController
{
     ...
     * 查询库存工作单列表
     */
//@RequiresPermissions("ware:task:list")
    @GetMapping("/list")
     ...
     * 导出库存工作单列表
     */
    //@RequiresPermissions("ware:task:export")
     ...
     * 获取库存工作单详细信息
     */
    //@RequiresPermissions("ware:task:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增库存工作单
     */
    //@RequiresPermissions("ware:task:add")
     ...
     * 修改库存工作单
     */
    // @RequiresPermissions("ware:task:edit")
     ...
     * 删除库存工作单
     */
    //@RequiresPermissions("ware:task:remove")
