...
public class WareSkuController extends BaseController
{
     ...
     * 查询商品库存列表
     */
//@RequiresPermissions("ware:sku:list")
    @GetMapping("/list")
     ...
     * 导出商品库存列表
     */
    //@RequiresPermissions("ware:sku:export")
     ...
     * 获取商品库存详细信息
     */
    //@RequiresPermissions("ware:sku:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增商品库存
     */
    //@RequiresPermissions("ware:sku:add")
     ...
     * 修改商品库存
     */
    // @RequiresPermissions("ware:sku:edit")
     ...
     * 删除商品库存
     */
    //@RequiresPermissions("ware:sku:remove")
